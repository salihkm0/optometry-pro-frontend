...
// Reuse the same UserForm component
      ...
      <div className="relative top-20 mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-md bg-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            {/* Shop Selection - Admin can assign to any shop */}
            <div className="sm:col-span-2">
              <label className="block text-sm font-medium text-gray-700">
                Shop Assignment *
              </label>
  ...
  const loadUsers = async (shopId = '') => {
    try {
      ...
      if (shopId) {
        ...
        // Fetch all users across all shops
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Manage all users across all shops (Admin Only)
          </p>
        </div>
...
export default withPermission(AdminUsers, 'users', 'manage')